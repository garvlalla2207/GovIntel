...
const Home = () => {
  ...
  return (
    <Layout>
      {/* 1. Changed h-calc to -120px to pull the container further up from the bottom.
        2. Added pb-20 (Padding Bottom) to ensure content has a large gap before the scroll ends.
      */}
      <div className="h-[calc(100vh-120px)] overflow-y-auto pr-4 pb-20 custom-scrollbar">
        ...
        {/* Extra spacer div to force real empty space at the very bottom */}
